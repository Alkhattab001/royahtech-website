...
export function Services() {
  ...
  const services = [
    {
      id: 'web-development',
      titleKey: "extendedServices.items.webDevelopment.title",
      descriptionKey: "extendedServices.items.webDevelopment.description",
    ...
    {
      id: 'ai-integration',
      titleKey: "extendedServices.items.aiIntegration.title",
      descriptionKey: "extendedServices.items.aiIntegration.description",
      color: 'accent-blue',
      rotation: '-rotate-1',
    ...
    {
      id: 'automation',
      titleKey: "extendedServices.items.automation.title",
      descriptionKey: "extendedServices.items.automation.description",
      color: 'accent-purple',
      rotation: 'rotate-1',
    ...
    {
      id: 'consulting',
      titleKey: "extendedServices.items.consulting.title",
      descriptionKey: "extendedServices.items.consulting.description",
      color: 'accent-emerald',
      rotation: '-rotate-2',
    ...
    {
      id: 'mobile-apps',
      titleKey: "extendedServices.items.mobileApps.title",
      descriptionKey: "extendedServices.items.mobileApps.description",
      color: 'accent-blue',
      rotation: 'rotate-3',
    ...
    {
      id: 'cloud-solutions',
      titleKey: "extendedServices.items.cloudSolutions.title",
      descriptionKey: "extendedServices.items.cloudSolutions.description",
      color: 'accent-purple',
      rotation: '-rotate-1',
        ...
        <div className="text-center mb-16">
          <div className={`inline-flex items-center gap-3 mb-6 transform transition-all duration-1000 ${
            ...
            <span className="text-sm font-semibold text-amber-200/80">
              {t('extendedServices.subtitle')}
            </span>
            <div className="w-3 h-3 bg-amber-500 rounded-full animate-pulse" />
          </div>
          
          <h2 className={`text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6 text-amber-100 section-title transform transition-all duration-1000 delay-200 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
          }`}>
            {t('extendedServices.title')}
          </h2>

          <p className={`text-xl text-amber-200/90 leading-relaxed max-w-3xl mx-auto section-subtitle transform transition-all duration-1000 delay-400 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          }`}>
            {t('extendedServices.subtitle')}
          </p>
                ...
                >
                  ...
                  <div className="relative bg-white p-4 pb-8 shadow-2xl cursor-pointer w-[260px] sm:w-[280px] max-w-[90vw]"
                    ...
                    <div className="relative">
                      <h3 className="font-black text-lg text-gray-800 mb-3 leading-tight card-title">
                        {t(service.titleKey)}
                      </h3>

                      <p className="text-sm text-gray-600 leading-relaxed card-description">
                    ...
                    <div className="absolute bottom-2 right-2 text-xs text-gray-400 font-mono opacity-60">
                      {i18n.language === 'ar' ? 'مختبر رؤية' : 'ROYAH LAB'}
                    </div>
                  </div>
                </div>
              ))}
